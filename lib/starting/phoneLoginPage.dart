...
//       // 00962 format -> convert to +962
//       phoneNumber = '+${phoneNumber.substring(2)}';
//     } else if (phoneNumber.startsWith('0962')) {
//       // 0962 format -> convert to +962
//       phoneNumber = '+${phoneNumber.substring(1)}';
//     } else if (phoneNumber.startsWith('962')) {
//       // 962 format -> add +
//       phoneNumber = '+$phoneNumber';
//     } else if (phoneNumber.startsWith('07')) {
//       // 07xxxxxxxx format (Jordanian local) -> convert to +9627xxxxxxxx
//       phoneNumber = '+962${phoneNumber.substring(1)}';
//     } else if (phoneNumber.startsWith('7') && phoneNumber.length == 9) {
//       // 7xxxxxxxx format (without 0) -> convert to +9627xxxxxxxx
//       phoneNumber = '+962$phoneNumber';
//     } else if (!phoneNumber.startsWith('+')) {
//       // If no country code and not Jordanian format, assume it's international
//       // User must include country code
//       setState(() {
//         _isLoading = false;
//       });
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(
//           content: Text('الرجاء إدخال رقم الهاتف بصيغة صحيحة مع رمز الدولة'),
...
//           });
//
//           String errorMessage = 'فشل التحقق';
//           if (e.code == 'invalid-phone-number') {
//             errorMessage = 'صيغة رقم الهاتف غير صحيحة';
//           } else if (e.code == 'too-many-requests') {
//             errorMessage = 'عدد كبير من المحاولات. الرجاء المحاولة لاحقاً';
//           } else if (e.code == 'operation-not-allowed') {
//             errorMessage = 'المصادقة عبر الهاتف غير مفعلة';
//           } else {
...
//       });
//       ScaffoldMessenger.of(context).showSnackBar(
//         SnackBar(content: Text('خطأ: $e'), duration: Duration(seconds: 5)),
//       );
//     }
//   }
//
...
//   }
//
//   // Sign in with credential and save to Firestore
