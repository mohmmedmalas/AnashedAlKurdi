...
class NasheedListByCategoryPage extends StatefulWidget {
  const NasheedListByCategoryPage({Key? key , required this.categoryID , required this.categoryName}) : super(key: key);
  final String categoryID ;
  final String categoryName ;

  @override
  State<NasheedListByCategoryPage> createState() => _NasheedListByCategoryPageState();
}

class _NasheedListByCategoryPageState extends State<NasheedListByCategoryPage> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      data.clear();
      data = await fetchDataByCategory(categoryId:  widget.categoryID);
      dataLeadList = List.of(data) ;
      setState(() {});
    });
  }
  @override
